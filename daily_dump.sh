...
OUTPUT_DIR="/var/backups/mariadb/relappropublishers"
FILE=relappropublishers.`date +"%d%m%Y"`.sql
DBSERVER=127.0.0.1
DATABASE=relappropublishers
USER=relapprod
PASS=R3l4pPr02017
...
echo "${OUTPUT_DIR}/${FILE}.gz was created:" >> /opt/dbScripts/relappropublishers.log
